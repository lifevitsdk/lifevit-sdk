 ...
 */
public class LifevitSDKBleDeviceTensiometerBPM300 extends LifevitSDKBleDevice {

    private final static String CLASS_TAG = LifevitSDKBleDeviceTensiometerBPM300.class.getSimpleName();
    ...
    protected LifevitSDKBleDeviceTensiometerBPM300(BluetoothDevice dev, LifevitSDKManager ch) {
    ...
    protected static boolean isTensiometerBPM300Device(String name) {
